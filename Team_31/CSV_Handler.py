...
#===============================================================================================================================================
    ...
    @staticmethod
    def loadMembers():     #returns a dict containing information about members
        dict={}
        with open('members.csv', mode ='r')as file:
            reader = csv.reader(file)
            for row in reader:    #format of row in CSV file: Roll Number , Name , Password 
...
#    CSV file structure
#    bookID1 , borrower->borrowed_date~returned_date borrower->borrowed_date~None
# FORMAT OF DICTIONARY
# dict= { bookID 1: {'rollnumber1':[dateIssued,DateReturned], 'rollnumber2':[dateIssued,None]} 
#       
#       } 
